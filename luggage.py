...
link_set = extract_link('https://www.montanawestusa.com/collections/wholesale-montana-west-western-cowgirl-luggages')
...
for each_link in link_set:
    ...
    time.sleep(1)
    file = open('Luggage.csv', 'a')
    error = extract_data(driver, file)
    if error == 1:
        error_file = open('error_file_luggage.txt', 'a')
